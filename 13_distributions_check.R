...
# save(nT_period_overall,file="datafiles/nT_period_overall.Rdata")
# save(nT_period_precollar,file="datafiles/nT_period_precollar.Rdata")
...
# save(nT_period_collar,file="datafiles/nT_period_collar.Rdata")
...
# load("datafiles/nT_period_overall.Rdata")
# load("datafiles/nT_period_precollar.Rdata")
# load("datafiles/nknots_age.Rdata")
# load("datafiles/nknots_period.Rdata")
# load("datafiles/nT_age_surv.Rdata")
# load("datafiles/nT_period_collar.Rdata")
